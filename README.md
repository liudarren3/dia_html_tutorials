...
## Your bio (Aka adding text and images)
...
7. If you don't want a Title, you can click the 'Title' button on the left and click the blue switch button. If you do not want an image, click the empty image box and click the blue switch button
...
10. Click the image on the window and click the blue 'Done' button in the top right.
